...
export default function Vision() {
  return (
    <div className="w-full bg-[#1e1e1e] h-screen text-black flex flex-col md:flex-row items-center justify-center  ">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="w-full md:w-[50%] h-[100vh] bg-[#1e1e1e] text-white flex flex-col items-center px-20 justify-center md:items-start gap-5"
      >
        ...
        <button className="border-2 border-b-[#94cb3d] text-white rounded-xl px-6 py-2 text-sm md:text-base hover:bg-transparent  duration-300 cursor-pointer">
          Read More
        </button>
      </motion.div>
    </div>
