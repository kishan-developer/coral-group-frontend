...
export default function Zig_Zag_2() {
    return (
        <div className="w-full bg-white h-screen text-black flex flex-col md:flex-row-reverse items-center justify-center  ">
            ...
            >
                <img
                    ...
                    alt="white_carpet"
                    className="w-[80%] md:w-[100%] h-[100%]  shadow-lg hover:scale-105 duration-300"
                />
            </motion.div>
            ...
            >
                ...
                <button className="border-4 border-b-gray-500 hover:border-b-[#94cb3d] bg-black text-white rounded-xl px-6 py-2 text-sm md:text-base hover:bg-transparent hover:text-[#94cb3d] duration-400 cursor-pointer">
                    Read More
                </button>
            </motion.div>
        </div>
